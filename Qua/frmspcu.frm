VERSION 5.00
Begin {C62A69F0-16DC-11CE-9E98-00AA00574A4F} frmspcu 
   OleObjectBlob   =   "frmspcu.frx":0000
   Caption         =   "계수형 관리도 u"
   ClientHeight    =   4425
   ClientLeft      =   45
   ClientTop       =   375
   ...
   TypeInfoVer     =   43
End
Attribute VB_Name = "frmspcu"
Attribute VB_Base = "0{052035C5-D30A-42D2-AF17-D81044716D28}{01A7A58E-7D83-4312-9B3C-8F3AD9A6EC06}"
...
ShellExecute 0, "open", "hh.exe", ThisWorkbook.Path + "\hist_help_V.2.5.1.chm::/U2.htm", "", 1
End Sub
...
'Rinterface.RRun " plot(u, title = " & Chr(34) & "U 관리도" & Chr(34) & ")"
