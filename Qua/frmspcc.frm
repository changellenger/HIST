VERSION 5.00
Begin {C62A69F0-16DC-11CE-9E98-00AA00574A4F} frmspcc 
   OleObjectBlob   =   "frmspcc.frx":0000
   Caption         =   "계수형 관리도 c"
   ClientHeight    =   3030
   ClientLeft      =   45
   ClientTop       =   375
   ...
   TypeInfoVer     =   41
End
Attribute VB_Name = "frmspcc"
Attribute VB_Base = "0{581B30DD-EE68-4B42-8398-E8E9965B5E0A}{F0972BFE-1231-4E49-A7FF-6A5822A83263}"
...
ShellExecute 0, "open", "hh.exe", ThisWorkbook.Path + "\hist_help_V.2.5.1.chm::/C.htm", "", 1
End Sub
...
b = " c <- qcc(arraytest, type= " & Chr(34) & "c" & Chr(34) & ", size=1000, title= " & Chr(34) & "C 관리도" & Chr(34) & ")"
'Rinterface.RRun "qcc.options(" & Chr(34) & "beyond.limits" & Chr(34) & " =list(pch=15, col= " & Chr(34) & "orangered" & Chr(34) & "))"
'Rinterface.RRun " plot(c, title = " & Chr(34) & "C 관리도" & Chr(34) & ")"
