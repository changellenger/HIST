VERSION 5.00
Begin {C62A69F0-16DC-11CE-9E98-00AA00574A4F} frmspcr 
   OleObjectBlob   =   "frmspcr.frx":0000
   Caption         =   "Xbar-R"
   ClientHeight    =   4065
   ClientLeft      =   45
   ClientTop       =   375
   ...
   TypeInfoVer     =   58
End
Attribute VB_Name = "frmspcr"
Attribute VB_Base = "0{C0BED2FE-FD2F-4B1D-BC5E-65EE2F7EF3E2}{B236F592-4807-4352-9B2A-5B6F4EF09DE3}"
...
'Rinterface.RRun " plot(r, title = " & Chr(34) & "R 관리도" & Chr(34) & ")"
Rinterface.RRun c
...
Private Sub HlpBtn_Click()
 ShellExecute 0, "open", "hh.exe", ThisWorkbook.Path + "\hist_help_V.2.5.1.chm::/Xbar-R.htm", "", 1
End Sub
