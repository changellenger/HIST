VERSION 5.00
Begin {C62A69F0-16DC-11CE-9E98-00AA00574A4F} frameOneTtest 
   OleObjectBlob   =   "frameOneTtest.frx":0000
   Caption         =   "단일표본 t 검정"
   ClientHeight    =   5805
   ClientLeft      =   45
   ClientTop       =   375
   ...
   TypeInfoVer     =   96
End
Attribute VB_Name = "frameOneTtest"
Attribute VB_Base = "0{A448208B-065D-491F-AF1A-9F2DEEEB3DBC}{75AEFE69-E88F-4D4C-ABA5-565B036826CE}"
...
Private Sub HlpBtn_Click()
 ShellExecute 0, "open", "hh.exe", ThisWorkbook.Path + "\hist_help_V.2.5.chm::/단일표본_T검정.htm", "", 1
End Sub
