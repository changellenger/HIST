VERSION 5.00
Begin {C62A69F0-16DC-11CE-9E98-00AA00574A4F} doe4 
   OleObjectBlob   =   "doe4.frx":0000
   Caption         =   "주효과도"
   ClientHeight    =   4245
   ClientLeft      =   45
   ClientTop       =   375
   ...
   TypeInfoVer     =   14
End
Attribute VB_Name = "doe4"
Attribute VB_Base = "0{85BFCB90-A847-48EC-B185-692279082FE6}{5B7DAD86-0BA5-4DB1-BC02-20BD6BE48319}"
...
Dim s3535 As Worksheet
   ...
   ' MsgBox temp
    ...
    rinterface.InsertCurrentRPlot Range("J2"), widthrescale:=0.5, heightrescale:=0.5, closergraph:=True
