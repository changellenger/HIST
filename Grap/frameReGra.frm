VERSION 5.00
Begin {C62A69F0-16DC-11CE-9E98-00AA00574A4F} frameReGra 
   OleObjectBlob   =   "frameReGra.frx":0000
   Caption         =   "적합선그림"
   ClientHeight    =   6960
   ClientLeft      =   45
   ClientTop       =   375
   ...
   TypeInfoVer     =   21
End
Attribute VB_Name = "frameReGra"
Attribute VB_Base = "0{74157579-D967-4ECA-8D78-7B9269D4CA9D}{2A9EDB54-F532-4012-9E3F-220AD5E2799A}"
...
Next s3535  '시트가 이미있으면 출력 위치 저장을하고, 없으면 2을 저장한다.
    ...
    If Me.CheckBox1.Value = False Then
        ModuleReGra.ScatterPlot "_통계분석결과_", posi(0), posi(1), 200, 200, x, y, Vname(1), Vname(2), Me.CheckBox2.Value
    Else
        ModuleReGra.OrderScatterPlot "_통계분석결과_", posi(0), posi(1), 200, 200, y, Vname(2), 0
    End If
...
Private Sub prv_Click()
 ...
 '   End If
    ...
    If Me.CheckBox1.Value = False Then
      tempchartO = ModuleReGra.ScatterPlotprv("_통계분석결과_", posi(0), posi(1), 200, 200, x, y, Vname(1), Vname(2), Me.CheckBox2.Value)
      '  tempchartO = ModuleReGra.OrderScatterPlotprv("_통계분석결과_", posi(0), posi(1), 200, 200, y, Vname(2), 0)
    Else
     tempchartO = ModuleReGra.OrderScatterPlotprv("_통계분석결과_", posi(0), posi(1), 200, 200, y, Vname(2), 0)
    End If
