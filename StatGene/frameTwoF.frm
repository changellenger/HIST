VERSION 5.00
Begin {C62A69F0-16DC-11CE-9E98-00AA00574A4F} frameTwoF 
   OleObjectBlob   =   "frameTwoF.frx":0000
   Caption         =   "따라하기 : σ₁²/σ₂²에 대한 F-검정"
   ClientHeight    =   5850
   ClientLeft      =   45
   ClientTop       =   375
   ClientWidth     =   11130
   ...
   TypeInfoVer     =   70
End
Attribute VB_Name = "frameTwoF"
Attribute VB_Base = "0{82BF371A-16DB-4A57-89ED-E66E94B23597}{F134F99B-CACC-45A7-B02F-50AE94815FA2}"
...
Next s3535  '시트가 이미있으면 출력 위치 저장을하고, 없으면 2을 저장한다.
  ...
  '  End If
   ...
   ' If Me.ChB2.Value = False Then choice(2) = -1
    ...
    '''결과 처리
    '''
    TModuleControl.SettingStatusBar True, "이표본 f-검정중입니다."
    ...
    TModuleControl.FTest1 choice, 1
