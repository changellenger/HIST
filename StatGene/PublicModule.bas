...
Public Declare Function ShellExecute _
 ...
 As Long
Function SelectedVariable1(ParentDlgLbxValue, selvar, _
   ...
   Chk_Ver = ChkVersion1(ActiveWorkbook.Name)
...
Function FindVarCount1(ListVar) As Long
...
End Function
Function ChkVersion1(File_Name) As Boolean
